              ...
              <table cellpadding="0" cellspacing="0" border="0" style={{ borderCollapse: 'separate' }}>
                <tbody>
                  <tr>
                    ...
                    <td style={{ padding: '0px 1px 0px 0px', verticalAlign: 'top' }}>
                      <table cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                          <tr>
                            <td style={{ padding: '0px 1px 8px 0px', borderBottom: '1px solid rgb(0,0,0)', fontFamily: 'Arial, sans-serif', fontSize: '13px', lineHeight: '15px', whiteSpace: 'nowrap' }}>
                              <p style={{
                              ...
                              <table cellpadding="0" cellspacing="0" border="0">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td style={{ lineHeight: '15px', padding: '1px 0px', verticalAlign: 'middle' }}>
                                      <p style={{ margin: '1px' }}>
                                        <a href={fullWebsiteURL} style={{ fontFamily: 'Arial, sans-serif', fontSize: '13px', lineHeight: '15px', color: 'rgb(0,0,0)', fontWeight: '700', textDecoration: 'none' }}>
                                          {website}
                                        </a>
                                      </p>
                                    </td>
          ...
          <tr>
            <td style={{ padding: '0px 1px 0px 0px' }}>
              <table cellpadding="0" cellspacing="0" border="0" style={{ maxWidth: '600px' }}>
                <tbody>
                  <tr>
                    <td style={{ padding: '12px 1px 0px 0px', fontFamily: 'Arial, sans-serif', fontSize: '10px', lineHeight: '12px', color: 'rgb(136,136,136)', textAlign: 'justify'  }}>
                      <p style={{ margin: '1px' }}>
